...
public class Subscription extends MapElement {
    ...
    public Subscription(String _id, String _rev, String type, SubscriptionProperties properties, MapElementGeometry geometry, String lastAction, String user) {
        super._id = _id;
        super._rev = _rev;
        super.type = type;
    ...
    public Subscription(JsonObject subscription) {
        _id = subscription.get("_id").getAsString();
